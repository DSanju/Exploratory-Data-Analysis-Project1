...
par(mfrow=c(2,2))
plot(date_time, as.numeric(as.character(Global_active_power)), type="l", xlab="", ylab="Global Active Power")

plot(date_time, as.numeric(as.character(Voltage)), type="l", xlab="datetime", ylab="Voltage")
...
plot(date_time, as.numeric(as.character(Global_reactive_power)), type="l", xlab="datetime", ylab="Global_reactive_power")
dev.off()