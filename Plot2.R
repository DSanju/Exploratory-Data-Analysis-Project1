...
#Plot2: plot commands to get histogram in png file with specific width and height
png("plot2.png", width=480, height=480, units="px")
#Global active power minute by minute plot
plot(date_time, as.numeric(as.character(Global_active_power)), type="l", xlab="", ylab = "Global Active Power(kilowatts)")
dev.off()